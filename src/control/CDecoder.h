 ...
 * @date   2010
 * @brief  A decoder for Parrot's H264 video encoding by <a href="http://labe.felk.cvut.cz/~tkrajnik/">Tom Krajnik</a>.
 *
*/

//!  A decoder for Parrot's H264 video encoding by <a href="http://labe.felk.cvut.cz/~tkrajnik/">Tom Krajnik</a>.
class CDecoder
{
public:
