function uncoveredNum = FuzzyClusteringFunc(seed,AOV_degree, R_min, R_max, Dim1_max, Dim2_max, max_iteration, uncovered_fraction_criterion, ClusterNum, TargetCount, coeff, blend, multi_class_probability)
    %FuzzyClustering
   ...
   % coeff = 10;% to scale angle and magnitude 

    minimum_dist = 0.01;
    multi_class_probability = 0.7;
