...
if ( Case(1) == 1 )
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %for upper side of camera line = - AOV/2 angle with main line
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Pass a line through origin with angle pi/2-AOV/2+best_fit_angle
    slope_up = tan( pi/2 - AOV/2  + best_fit_angle );
    %p2 = [slope_up, 0];
    V1 = [ 0, 0, 0 ];
    V2 = [ 1, slope_up, 0 ];
    x_axis_pt1 = [ 0, 0, 0 ];
    ...
    plot([ V1(1), V2(1) , 12 ], [ V1(2), V2(2), slope_up * 12 ] , 'm'); hold on; 

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
    %Now for the lower side of camera line --> + AOV/2 angle with main line
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    slope_down = tan( pi/2 + AOV/2 + best_fit_angle );
    V3 = [ 0, 0, 0 ];
    V4 = [ 1, slope_down, 0 ];
    x_axis_pt1 = [ 0, 0, 0 ];
    x_axis_pt2 = [ 1, 0, 0 ];
    ...
    plot([V3(1), V4(1) , 12 ], [V3(2), V4(2), slope_down * 12 ] , 'm'); hold on; 
    ...
    slope_up = tan( AOV/2 - pi + best_fit_angle );
    %p2 = [slope_up, 0];
    V1 = [ 0, 0, 0 ];
    V2 = [ 1, slope_up, 0 ];
    x_axis_pt1 = [0, 0, 0];
    ...
    %Now for the lower side of camera line : - AOV/2 angle with main line
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    slope_down = tan( best_fit_angle - AOV/2 );
    V3 = [ 0, 0, 0 ];
    V4 = [ 1, slope_down, 0 ];
    for i = 1 : TargetNum
       test_pt = [X(i), Y(i), 0];
...
ray_angle_case1 = [ pi + best_fit_angle - AOV/2, best_fit_angle + AOV/2 ];
ray_angle_case2 = [ pi + best_fit_angle + AOV/2, best_fit_angle - AOV/2 ];
%ray_angle = 
ray_slope_case1 = tan( ray_angle_case1 );
ray_slope_case2 = tan( ray_angle_case2 );
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if ( Case(1) == 1 )
    ray_slope = ray_slope_case1;
else
    ray_slope = ray_slope_case2;
end
...
for i = 1 : TargetNum
     ...
     % test range
     test_dist( i ) = EuclideanDist(test_pt, CAM);
