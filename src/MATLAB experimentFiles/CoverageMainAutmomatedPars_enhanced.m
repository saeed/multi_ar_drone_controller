...
targets_vec = [10, 20, 40, 60, 80, 100];%20 30 40 50];% 60 70 80 90 100 200 400 600 800 1000];
%targets_vec = [20];
if 0
t = 0; %target counter
...
%for TargetCount = 10: 10: 100
  ...
  figure;
  plot(targets_vec,camNum_avg_fuzzy);
  xlabel('#targets');
  ylabel('#cameras');
  title('Algorithm Fuzzy ');
  figure;
  plot(targets_vec, uncoveredNum_fuzzy_avg);
  xlabel('#targets');
  ylabel('#uncovered');
  title('Algorithm Fuzzy ');
  ...
  figure;
  %plot(UncoveredVsCamNum2(1:CamCountAlgo2));
  plot(targets_vec, exec_time_fuzzy_avg);
  xlabel('#targets');
  ylabel('execution time');
  title('Algorithm Fuzzy ');
