...
for i = 1 : TargetCount
    Targets(i) = TargetClass( data( 1,i ), data( 2,i ), data( 3,i ), 1 );
    if (( data( 1 , i ) < (1/5)*Dim1_max ))
        Targets(i).cluster_index = 1;
    elseif (( data( 1 , i ) > (1/5)*Dim1_max ) & ( data( 2 , i ) < (2/5)*Dim1_max ))
         Targets(i).cluster_index = 2;
    elseif (( data( 1 , i ) > (2/5)*Dim1_max ) & ( data( 2 , i ) < (3/5)*Dim1_max ))
         Targets(i).cluster_index = 3;
    elseif (( data( 1 , i ) > (3/5)*Dim1_max )  & ( data( 2 , i ) < (4/5)*Dim1_max ))
         Targets(i).cluster_index = 4;
    elseif ( data( 2 , i ) > (4/5)*Dim1_max )
         Targets(i).cluster_index = 5;
    end
