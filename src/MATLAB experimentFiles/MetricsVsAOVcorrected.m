...
legend('KCam-R1', 'KCam-R2', 'CF-R1', 'CF-R2', 'Hybrid-kmeans-R1', 'Hybrid-kmeans-R2', 'Hybrid-tree-R1', 'Hybrid-tree-R2',  'Fuzzy-R1', 'Fuzzy-R2','Greedy', '2-Smp','FontName','Times New Roman');
...
plot(AOV, coverage_greedy, '-ko', 'LineWidth',2,'MarkerSize',8); hold on;
plot(AOV, coverage_dual, '--kd', 'LineWidth',2,'MarkerSize',8); 
legend('KCam-R1', 'KCam-R2', 'CF-R1', 'CF-R2', 'Hybrid-kmeans-R1', 'Hybrid-kmeans-R2', 'Hybrid-tree-R1', 'Hybrid-tree-R2',  'Fuzzy-R1', 'Fuzzy-R2','Greedy', '2-Smp','FontName','Times New Roman');
xlabel('angle(deg)', 'FontSize', 24,'FontName','Times New Roman');
